...
class ShellTool(BaseTool):
    ...
    @tool(
        ...
        description="在指定 Shell 会话中终止正在进行的进程。用于停止长时间运行的进程或处理卡死的命令。",
        parameters={
            "session_id": {
                "type": "string",
                "description": "目标 Shell 会话的唯一标识",
